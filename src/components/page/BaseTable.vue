<template>
    <div class="table">
        ...
        <div class="handle-box">
            <el-button type="primary" icon="delete" class="handle-del mr10" @click="dellAll">批量删除</el-button>
...
export default {
            ...
            return self.tableData.filter(function(d){
                ...
                if(!is_del){
                    if(d.address.indexOf(self.select_cate) > -1 &&
                        (d.name.indexOf(self.select_word) > -1 || d.address.indexOf(self.select_cate) )
                    ){
                        return d;
                    }
                }
    ...
    methods:{
        ...
        dellAll(){
            ...
            let str = '';
            self.del_list = self.del_dist.concat(self.multipleSelection);
